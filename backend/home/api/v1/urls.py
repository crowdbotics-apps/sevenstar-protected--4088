...
from home.api.v1.viewsets import PasswordResetAPI,LoginUserName,LoginUserNameCheckView,SignupViewSet,ImageUploadAPI,OfficerView,AppOfficerViewSet,AppCitizenViewSet, LoginViewSet, HomePageViewSet, CustomTextViewSet
...
urlpatterns = [
    ...
    path('app-login/', LoginUserName.as_view()),
]